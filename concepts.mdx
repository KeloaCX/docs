...
A **channel** is a connection between Keloa and an outside system that carries messages — webchat, email, WhatsApp, Instagram, Messenger, or Shopify. Each channel has a status (*connected*, *pending setup*, *disconnected*) and can be bound to an AI agent.
