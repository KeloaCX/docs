...
<Steps>
  ...
  <Step title="Pick your first channel">
    Choose **Webchat** for the fastest path — it requires no third-party approval. (WhatsApp, Instagram and Messenger need provider connections, see [Channels](/channels/overview).)
  ...
  <Step title="Install the widget on your site">
    Open **Settings → Widget** to grab your one-line embed snippet:
    ...
    Paste it before `</body>` on any page. Refresh and a chat bubble appears in the bottom-right.
