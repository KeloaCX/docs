...
<AccordionGroup>
  <Accordion title="Is there a free plan?">
    Yes — **Starter** is free forever. 100 AI replies/month, 1 channel, 1 seat. Upgrade any time.
  </Accordion>
  ...
  <Accordion title="Can I pay by invoice / SEPA?">
    Monthly plans are card + iDEAL + SEPA direct debit. Yearly plans on Business+ can be paid by bank invoice — email [sales@keloa.cx](mailto:sales@keloa.cx).
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can I sign a DPA?">
    Yes. Our template DPA is available at [keloa.cx/legal/dpa](https://keloa.cx/legal/dpa) — sign and email back, or request a countersign.
  </Accordion>
